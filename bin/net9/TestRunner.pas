...
{$reference System.Text.Encoding.CodePages.dll}
...
begin
  //var q1 := &File.ReadLines(dir + PathSeparator + 'testsettings.config');
  //var q2 := System.Linq.Enumerable.Select(q1,line -> line.Split([':', ' '], System.StringSplitOptions.RemoveEmptyEntries));
  //var configDict := System.Linq.Enumerable.ToDictionary(q2,arr -> arr[0], arr -> arr[1]);
  ...
  var tt := Languages.Facade.LanguageProvider.Instance.Languages;
  var languageInformation := Languages.Facade.LanguageProvider.Instance.SelectLanguageByName('PascalABC.NET').LanguageInformation;
...
begin
  ...
  var q := System.Linq.Enumerable.SelectMany(extensions,ext -> Directory.GetFiles(path, $'*{ext}', searchOption));
  Result := System.Linq.Enumerable.ToArray(q);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      Message('Compilation of ' + files[i] + ' failed' + System.Environment.NewLine + comp.ErrorsList[0].ToString());
      Halt();
    end;
    ...
    begin
      ...
      begin
        ...
        Message('Missing warning in ' + files[i]);
        Halt();
      end;
      ...
      begin
        ...
        Message('Wrong warning for ' + files[i] + ': ' + comp.Warnings[0].Message);
        Halt();
      end;
    end;
    if i mod 50 = 0 then
...
begin
  ...
  begin
    ...
    begin
      ...
      Message('Compilation of error sample ' + files[i] + ' was successfull' + System.Environment.NewLine);
      Halt();
    end
    ...
    begin
      ...
      begin
        ...
        Message('Wrong error message in file ' + files[i] + ', should ' + errorMessage + ', is ' + comp.ErrorsList[comp.ErrorsList.Count - 1].Message);
      end;
    end;
    if i mod 50 = 0 then
      System.GC.Collect();
...
begin
  ...
  begin
    ...
    begin
      ...
      Message('Running of ' + files[i] + ' failed. Exit code is not 0');
      Halt;
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    Message(errors + System.Environment.NewLine + $'more info at {dirInfo.Parent.Name}/{dirInfo.Name}/formatter_tests/output/log.txt');
    Halt;
  end;
end;*)

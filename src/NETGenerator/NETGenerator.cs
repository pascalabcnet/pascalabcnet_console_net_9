...
// Не знаю, что делать с ресурсами в net 9 - надо разбираться
...
#if NET
            // SSM 11.06.25 - самая главная часть ради которой всё затевалось - сохраниение сборки
            ...
            foreach (FileStream fs1 in ResStreams)
                fs1.Close();
        }
        ...
        private void MakeAttribute(ICommonFunctionNode func)
        {
            ...
            for (int i = 0; i < attrs.Length; i++)
            {
                ...
                if (attrs[i].qualifier == SemanticTree.attribute_qualifier_kind.return_kind)
                {
                    ...
                    {
#if NET48
                            // SSM 11.06.25 - убрал пока в net 9 - не знаю, что с этим делать
        ...
        public void ConvertGenericParamCtorCall(ICommonConstructorCall value)
        {
            ...
            /// SSM 03.01.26 - измененная строка по сравнению с июнем 25. Оставляю

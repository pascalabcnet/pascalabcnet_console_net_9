...
begin
  var Files := DirectoryInfo.Create(Path.Combine('..', '..', 'bin', 'shared', 'Lng', 'Rus')).GetFiles('*.*');
  ...
  var ResWriter := ResourceWriter.Create(Path.Combine('..', '..', 'src', 'Localization', 'DefaultLang.resources'));
